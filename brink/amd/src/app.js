/*! Brink app.js
 * ================
 * Main JS application file for Brink v2. This file
 * should be included in all pages. It controls some layout
 * options and implements exclusive Brink plugins.
 *
 * @Author  Willian Mano
 */

/* jshint ignore:start */
define(['jquery', 'theme_brink/resize_sensor', 'core/log'], function($, ResizeSensor, log) {

    "use strict"; // jshint ;_;

    log.debug('Theme Brink AMD initialised');

    /* Brink
     *
     * @type Object
     * @description $.Brink is the main object for the template's app.
     ...
     * - Implementation -
     * ------------------
     * The next block of code implements Brink's
    ...
    $(function() {
        ...
        if (typeof BrinkOptions !== "undefined") {
            $.extend(true,
                $.Brink.options,
                BrinkOptions);
        }
    ...
    /* ----------------------------------
     * - Initialize the Brink Object -
     * ----------------------------------
     * All Brink functions are implemented below.
     */
    function _init() {
         ...
         *
         * @type Object
         * @usage $.Brink.controlSidebar.activate(options)
         */
        $.Brink.controlSidebar = {
            //instantiate the object
            activate: function() {
                //Get the object
                var _this = this;
                //Update options
                var o = $.Brink.options.controlSidebarOptions;
                //Get the sidebar
                var sidebar = $(o.selector);
                //The toggle button
                var btn = $(o.toggleBtnSelector);
                //Get the screen sizes
                var screenSizes = $.Brink.options.screenSizes;
