...
$string['choosereadme'] = 'Brink is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'Brink';
$string['generalsettings'] = 'General settings';
$string['pluginname'] = 'Brink';
$string['presetfiles'] = 'Additional theme preset files';
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href=https://docs.moodle.org/dev/Brink_Presets>Brink presets</a> for information on creating and sharing your own preset files, and see the <a href=http://moodle.net/brink>Presets repository</a> for presets that others have shared.';
...
//for course renderer
$string['categories'] = 'Select the course category your\'re interested in 	' ;
$string['seriestext'] = 'Course Series';
$string['viewmod'] = 'View Modules';
$string['notags'] = 'No Tags';

//for category header settings
$string['categorysettings'] = 'Category Header Settings';
$string['categoryimg'] = 'Category Header image';
$string['categoryimgdesc'] = 'Upload your category header-image here if you want to add it to the header.mage works best if (Image size should be 1500px x 700px)';
$string['categorycontent'] = 'Category Header Content';
$string['categorycontentdesc'] = 'Category Header Content Text';