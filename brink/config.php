...
$THEME->scss = function($theme) {
    return theme_brink_get_main_scss_content($theme);
};

// Process extra scss to our final stylesheet.
$THEME->extrascsscallback = 'theme_brink_get_extra_scss';

// Process pre scss to our final stylesheet.
$THEME->prescsscallback = 'theme_brink_get_pre_scss';

// Add some javascript code to our theme.
$THEME->javascripts_footer = array('init_brink');
